  ...
  return (
    <div className="min-h-screen bg-zinc-200 font-sans">
      ...
      <nav className="border-b-4 border-black bg-white px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="border-4 border-black px-5 py-2 font-bold uppercase text-sm hover:bg-zinc-100 transition-colors"
          >
            Login
          </button>
          <button
            onClick={() => navigate("/register")}
            className="border-4 border-black px-5 py-2 font-bold uppercase text-sm bg-amber-500 hover:bg-amber-400 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all"
          >
            Register
          </button>
        </div>
      ...
      <section className="px-6 py-20 flex flex-col items-center text-center border-b-4 border-black bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button
              onClick={() => navigate("/register")}
              className="bg-amber-500 hover:bg-amber-400 border-4 border-black px-8 py-4 text-lg font-black uppercase shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all"
            >
              Get Started
            </button>
            <button
              onClick={() => navigate("/login")}
              className="bg-white hover:bg-zinc-100 border-4 border-black px-8 py-4 text-lg font-black uppercase shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all"
            >
              Login
            </button>
          </div>
      ...
      <section className="px-6 py-16 max-w-5xl mx-auto">
        <h2 className="text-3xl font-black uppercase mb-10 border-b-4 border-black pb-4">
          Why Shramik Voice?
        </h2>
      ...
      {/* CTA Banner */}
      <section className="mx-6 mb-16 border-4 border-black bg-amber-500 p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-5xl md:mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
